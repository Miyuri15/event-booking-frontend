...
export default function ExplorePage() {
  return (
    <AuthGuard allowedRoles={["ADMIN"]}>
      <AppShell
        title="Events"
        description="Admin-only event workspace for reviewing listings, organizing categories, and managing what appears in the platform."
      >
        <section className="rounded-[28px] border border-[var(--border)] bg-[var(--surface)] p-8 shadow-[var(--shadow)] backdrop-blur-[14px] max-[900px]:p-[1.4rem]">
          ...
          <h3 className="mb-3 text-[1.05rem]">Which event stream needs attention?</h3>
