const API_BASE_URL =
  process.env.NEXT_PUBLIC_API_BASE_URL || "http://localhost:8086";
...
// Fetch recent payment records from the payment service.
// Uses NEXT_PUBLIC_PAYMENT_API_URL if provided, otherwise falls back to localhost:5001
export function fetchRecentPayments(token) {
  const paymentBase = process.env.NEXT_PUBLIC_PAYMENT_API_URL || "http://localhost:5001";
